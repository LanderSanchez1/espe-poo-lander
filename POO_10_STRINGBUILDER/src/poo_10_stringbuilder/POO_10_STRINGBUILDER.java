...
public class POO_10_STRINGBUILDER {
    ...
    public static void main(String[] args) {
        ...
        // VARIABLE String donde se va guardar la cadena a crear
String cad;
  // Creamos el objeto StringBuilder
  //llamamos una variables aux donde guardamos la cadena invertida
  // la asociamos a una cadena vacia ""
  
StringBuilder aux=new StringBuilder (" ");
// pedimos al usario que introduzca cadena
System.out.println("Introduce una cadena");
//la vamos a guardar en la variable cad llamaos al objeto nextline
cad=sc.nextLine();
// hay que recorrerla en orden inverso desde la ultima posicion a la1ra
// for iniciamos desde el ultimo usamos length
